...
SCORING_2_0 = {'TP': 135, 'TN': 25, 'FP': 165, 'FN': 30, 'PRECISION': 90}
SCORING_3_0 = {'TP': 450, 'TN': 20, 'FP': 220, 'FN': 40, 'PRECISION': 100}

# High Multipliers - Aggressive Reward but Strict Precision Bonus
SCORING_5_0 = {'TP': 850, 'TN': 45, 'FP': 319, 'FN': 65, 'PRECISION': 150}
SCORING_10_0 = {'TP': 1950, 'TN': 1, 'FP': 250, 'FN': 50, 'PRECISION': 200}
SCORING_20_0 = {'TP': 8500, 'TN': 1, 'FP': 225, 'FN': 125, 'PRECISION': 300}
SCORING_30_0 = {'TP': 9900, 'TN': 1, 'FP': 200, 'FN': 150, 'PRECISION': 350}  # v0.9.4: Courage Boost (FP lower, FN higher)
SCORING_40_0 = {'TP': 17500, 'TN': 1, 'FP': 300, 'FN': 150, 'PRECISION': 450} # v0.9.4: Courage Boost
SCORING_50_0 = {'TP': 22500, 'TN': 1, 'FP': 500, 'FN': 150, 'PRECISION': 500} # FP reduced from 750
...
CARD_THRESHOLDS = {
    ...
    2.0: {'GOLD': 0.54, 'RISK': 0.45},    
    3.0: {'GOLD': 0.35, 'RISK': 0.25},
    5.0: {'GOLD': 0.36, 'RISK': 0.25},
    10.0: {'GOLD': 0.25, 'RISK': 0.15},
    20.0: {'GOLD': 0.11, 'RISK': 0.08},
    30.0: {'GOLD': 0.14, 'RISK': 0.08},   
    40.0: {'GOLD': 0.14, 'RISK': 0.08},   
    50.0: {'GOLD': 0.24, 'RISK': 0.10}    
}
